param(
    ...
    [string]$Output = "prototype\test_output\eye_package_v4_miku_style",
    [string]$SaveBlend = "prototype\assets\characters\generated\eye_package_v4_miku_style.blend"
)
...
if($blendExit -ne 0) { throw "EyePackage v4 Blender build failed with exit code $blendExit" }

Write-Output "EYE_PACKAGE_V4_WRAPPER_PASS output=$outputPath blend=$blendPath"
