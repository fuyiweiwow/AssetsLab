...
def add_scalp_mask(actor: bpy.types.Object, hair: bpy.types.Object) -> dict[str, int]:
...
def main() -> None:
    ...
    for vertex in hair.data.vertices:
        ...
        if radial.length > 1e-8:
            mapped += radial.normalized() * SHELL_RADIAL_CLEARANCE
    ...
    mask_report = add_scalp_mask(actor, hair)

    hair["source_kind"] = "Hunyuan3D-2MV generated hair"
    hair["source_glb"] = str(args.source_glb.resolve())
    hair["actor_class"] = "ChibiActorV1"
    hair["wearable_slot"] = "head_hair"
    ...
    report = {
        ...
        "transform": {
            ...
            "shell_radial_clearance": SHELL_RADIAL_CLEARANCE,
